jQuery(document).ready(function() {
    ...
    jQuery(document).on('click', siteSettingsElementButtonTarget + ',' + addElementButtonTarget + ',' + documentSettingsElementButtonTarget + ', .twbb-customize-button, .twbb_editor_nav_menu,  header button[value="document-settings"]',function() {
        twbb_animate_sidebar(0);
    });
    ...
    if (open) {
        ...
        setTimeout(function() {
            ...
            if( typeof twbb_options.smart_scale_option !== "undefined" && twbb_options.smart_scale_option === 'active' ) {
                ...
                twbbIframeScale(0);
                jQuery('#elementor-preview').css('margin-left','280px');
            }

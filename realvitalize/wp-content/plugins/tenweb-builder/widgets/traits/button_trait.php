...
trait Button_Trait {
	...
	protected function register_button_style_controls( $args = [] ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
				'condition' => $args['section_condition'],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'global' => [
			    'default' => 'globals/typography?id=twbb_button',
				],
				'selector' => '{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button',
				'condition' => $args['section_condition'],
			]
		);
        ...
        'global' => [
          'default' => 'globals/colors?id=twbb_button_inv',
				...
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
				'condition' => $args['section_condition'],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => $args['section_condition'],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:hover, {{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:focus' => 'color: {{VALUE}};',
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:hover svg, {{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:focus svg' => 'fill: {{VALUE}};',
				],
        'global' => [
          'default' => 'globals/colors?id=twbb_button_inv',
        ],
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ], //phpcs:ignore WordPressVIPMinimum.Performance.WPQueryParams.PostNotIn_exclude
				'selector' => '{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:hover, {{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:focus',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:hover',
				'condition' => $args['section_condition'],
			]
		);
		...
		$this->add_responsive_control(
			$prefix . 'border_radius_hover',
			[
				'label' => esc_html__( 'Border Radius', 'tenweb-builder' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => $args['section_condition'],
			]
		);
		...
		$this->add_control(
			$prefix . 'button_hover_transition_duration',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .' . $prefix . 'button-wrapper .elementor-button' => 'transition-duration: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render_button( Widget_Base $instance = null, $prefix = '', $skin = '' ) {
		...
		if ( ! empty( $settings[$skin . $prefix . 'link']['url'] ) ) {
			$instance->add_link_attributes( $prefix . 'button', $settings[$skin . $prefix . 'link'] );

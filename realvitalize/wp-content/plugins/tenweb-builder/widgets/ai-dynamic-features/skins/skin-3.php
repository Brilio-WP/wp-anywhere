...
class Skin_3 extends Skin_Base {
	...
	public function update_controls_layout() {
		$this->update_control('feature_list_style_choice', ['default' => 'style_3']);
	...
	public function update_controls_content() {
		$this->update_control('image_animation', ['default' => 'soft_shift']);
		$this->update_control('image_animation_duration', ['default' => ['size' => 700]]);
		$this->update_responsive_control('content_width', ['default' => ['unit' => 'px', 'size' => 460]]);
		...
		$this->update_control('media_height', ['default' => ['size' => 480, 'unit' => 'px'], 'mobile_default' => ['size' => 228, 'unit' => 'px']]);

  ...
  public function register_features_list_style_controls() {
      ...
      $this->add_responsive_control(
        ...
        [
          ...
          'selectors'  => [
            '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list' => 'margin-bottom: {{SIZE}}{{UNIT}};',
          ],
        ]
      );
      ...
      $this->add_control(
        ...
        [
          ...
          'selectors'  => [
            '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}};',
          ],
        ]
      );
	    ...
	    $this->add_responsive_control(
          ...
          'mobile_default' => [
            ...
            'size' => $defaults[$style]['mobile_default']
			    ...
			    'selectors'  => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-list-item-description' => 'margin-top: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'selector'       => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item-title',
			    'render_type'    => 'ui',
			    'label'          => __( 'Title Typography', 'tenweb-builder' ),
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item-title' => 'color: {{VALUE}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-icon svg'    => 'color: {{VALUE}}; fill: {{VALUE}};',
			    ],
	    ...
	    $defaults = [
		    'style_1' => ['default' => '#000000ff', 'global' => []],
		    'style_2' => ['default' => '#000000ff', 'global' => []],
		    'style_3' => ['default' => '', 'global' => ['default' => 'globals/colors?id=primary']],
		    'style_4' => ['default' => '#00000080', 'global' => []],
		    'style_5' => ['default' => '', 'global' => ['default' => 'globals/colors?id=primary']],
		    'style_6' => ['default' => '#00000080', 'global' => []],
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item:hover .twbb-dynamic-features-list-item-title' => 'color: {{VALUE}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item:hover .twbb-dynamic-features-tab-icon svg'    => 'color: {{VALUE}}; fill: {{VALUE}};',
			    ],
				  'default' => $defaults[$style]['default'],
          'global' => $defaults[$style]['global'],
			    'render_type' => 'ui',
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-text .twbb-dynamic-features-list-item-title' => 'color: {{VALUE}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-text .twbb-dynamic-features-tab-icon svg'    => 'color: {{VALUE}}; fill: {{VALUE}};',
			    ],
          'default' => $defaults[$style]['default'],
          'global' => $defaults[$style]['global'],
			    'render_type' => 'ui',
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'selector'       => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item-description',
			    'render_type'    => 'ui',
			    'label'          => __( 'Description Typography', 'tenweb-builder' ),
          'fields_options' => $defaults[$style]['fields_options'],
          'global' => $defaults[$style]['global'],
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item-description' => 'color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item:hover .twbb-dynamic-features-list-item-description' => 'color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
		    ]
	    );
	    ...
	    $this->add_responsive_control(
		    ...
		    [
			    ...
			    'selectors'  => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg.bar'                     => 'height: calc(100% - {{TOP}}{{UNIT}} - {{BOTTOM}}{{UNIT}});',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content' => 'background-color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
		    ]
	    );
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'label'     => __( 'Border', 'tenweb-builder' ),
			    'selector'  => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content',
	    ...
	    $this->add_responsive_control(
		    ...
		    [
			    ...
			    'size_units' => [ 'px', '%' ],
			    'selectors'  => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content:hover' => 'background-color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
		    ]
	    );
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'label'     => __( 'Border', 'tenweb-builder' ),
			    'selector'  => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content:hover',
		    ]
	    );
	    ...
	    $this->add_responsive_control(
		    ...
		    [
			    ...
			    'size_units' => [ 'px', '%' ],
			    'selectors'  => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item .twbb-dynamic-features-list-item-content:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'type'        => \Elementor\Controls_Manager::COLOR,
			    'selectors'   => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-list-item-content' => 'background-color: {{VALUE}};',
			    ],
          'default' => $defaults[$style]['default'],
          'global' => $defaults[$style]['global'],
			    'render_type' => 'ui',
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'label'     => __( 'Border', 'tenweb-builder' ),
			    'selector'  => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-list-item-content',
		    ]
	    );
	    ...
	    $this->add_responsive_control(
          ...
          'default' => $defaults[$style],
			    'selectors'  => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item.active .twbb-dynamic-features-list-item-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'default' => '#0000001A',
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-mobile-view-slider .twbb-dynamic-features-swiper-pagination' => 'background-color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
			    'condition' => [
	    ...
	    $this->add_control(
	      $style . '_' . 'slider_pagination_dot_color',
		    [
			    ...
			    'default' => '#000000',
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-mobile-view-slider .twbb-dynamic-features-swiper[data-autoplay=yes] .twbb-dynamic-features-swiper-pagination .swiper-pagination-bullet' => 'background-color: {{VALUE}}80;',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-mobile-view-slider .twbb-dynamic-features-swiper[data-autoplay=yes] .twbb-dynamic-features-swiper-pagination .swiper-pagination-bullet-active' => 'background-color: {{VALUE}}4D;',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-mobile-view-slider .twbb-dynamic-features-swiper[data-autoplay=yes] .twbb-dynamic-features-swiper-pagination .swiper-pagination-bullet-active .progress-indicator' => 'background-color: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
			    'condition' => [
				    $this->get_control_id( $style . '_' . 'mobile_view' ) => 'slider',
	    ...
	    $this->add_group_control(
		    ...
		    [
			    ...
			    'label' => __('Border', 'tenweb-builder'),
			    'selector' => '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-swiper-pagination',
			    'condition' => [
				    $this->get_control_id( $style . '_' . 'mobile_view' ) => 'slider',
			    ],
		    ]
	    ...
	    $this->add_responsive_control(
	      $style . '_' . 'slider_pagination_border_radius',
		    [
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-swiper-pagination' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			    ],
			    'condition' => [
				    $this->get_control_id( $style . '_' . 'mobile_view' ) => 'slider',
			    ],
	    ...
	    $this->add_responsive_control(
          ...
          'mobile_default' => [
            ...
            'size' => $defaults[$style]['mobile_default']
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-progress-bar-position-left .twbb-dynamic-features-tab-progress-indicator' => 'margin-right: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"].twbb-dynamic-features-progress-bar-position-right .twbb-dynamic-features-tab-progress-indicator' => 'margin-left: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'condition' => [
            $this->get_control_id( $style . '_' . 'progress_indicator_type' ) => 'bar',
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator' => 'height: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg.bar .progress-bar' => 'height: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg.bar .progress-bar' => '--height: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg.bar .progress-bar-bg' => 'height: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'condition' => [
            $this->get_control_id( $style . '_' . 'progress_indicator_type' ) => 'bar',
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator' => 'width: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg' => 'width: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar' => 'width: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar-bg' => 'width: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'condition' => [
            $this->get_control_id( $style . '_' . 'progress_indicator_type' ) => 'bar',
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar' => 'rx: {{SIZE}}{{UNIT}}; ry: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar-bg' => 'rx: {{SIZE}}{{UNIT}}; ry: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'condition' => [
            $this->get_control_id( $style . '_' . 'progress_indicator_type' ) => 'circle',
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-list-item-title' => 'line-height: {{SIZE}}{{UNIT}} !important;',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
          ...
          'condition' => [
            $this->get_control_id( $style . '_' . 'progress_indicator_type' ) => 'circle',
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator .progress-circle' => 'stroke-width: {{SIZE}}{{UNIT}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator .progress-circle-bg' => 'stroke-width: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );
	    ...
	    $this->add_control(
	      $style . '_' . 'progress_indicator_color',
		    [
			    ...
			    'default' => '#0000001A',
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-circle-bg' => 'stroke: {{VALUE}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar-bg' => 'fill: {{VALUE}};',
			    ],
			    'render_type' => 'ui',
		    ]
	    );
	    ...
	    $this->add_control(
	      $style . '_' . 'progress_indicator_progress_color',
		    [
			    ...
			    'type' => \Elementor\Controls_Manager::COLOR,
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-circle' => 'stroke: {{VALUE}};',
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-progress-indicator svg .progress-bar' => 'fill: {{VALUE}};',
			    ],
				  'global' => [
            'default' => $defaults[$style],
          ],
	    ...
	    $this->add_responsive_control(
	      $style . '_' . 'feature_icon_size',
		    [
			    ...
			    'selectors' => [
				    '{{WRAPPER}}[data-widget_type="twbb_dynamic_features.' . $this->get_id() . '"] .twbb-dynamic-features-tab-icon svg' => 'width: {{SIZE}}{{UNIT}};',
			    ],
		    ]
	    );

...
class ActionsHooksElementor {
    ...
    */
    ...
    public function elementorInit() {
        ...
        $this->registerWPMLTranslationExperiment();
        $this->registerWebsiteNavigationExperiment();
    }
    ...
    private function registerWPMLTranslationExperiment() {
        \Elementor\Plugin::instance()->experiments->add_feature( [
            'name' => 'wmpl_translation',
    ...
    private function registerWebsiteNavigationExperiment() {
        \Elementor\Plugin::instance()->experiments->add_feature( [
